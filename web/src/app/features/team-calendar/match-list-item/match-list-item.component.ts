 ...
 * (unlike the mockup's hover-chevron treatment): there is no match-detail
 * page to navigate to in this MVP, so it stays a plain, non-interactive
 * row rather than implying a destination that doesn't exist.
 */
@Component({
